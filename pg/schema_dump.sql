...
pg_dump --host 192.168.1.2 --username "igow" --format custom --no-tablespaces -O --verbose --schema "streetevents" "crsp" | pg_restore --host localhost --username "igow" --dbname "crsp"   --verbose
